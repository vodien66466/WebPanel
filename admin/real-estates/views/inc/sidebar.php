<div class="sidebar" data-active-color="rose" data-background-color="black" data-image="<?php echo $core->asset("style/assets/img/sidebar-1.jpg","admin"); ?>">
            <!--
    ...
    -->
            ...
            <div class="sidebar-wrapper">
                <div class="user">
                    <div class="photo">
                        <img src="<?php echo $core->asset("style/assets/img/faces/avatar.jpg","admin"); ?>" />
                    </div>
                    <div class="info">
