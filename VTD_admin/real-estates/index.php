...
<html>
	<head>
		<?php include (system::path_theme($theme)."/incl/head.php"); ?>
	</head>
	<body class="sidebar-mini fixed">
	    ...
	    <div class="wrapper">
	    	<header class="main-header-top hidden-print">
	    		<?php include (system::path_theme($theme)."/incl/header.php"); ?>
	    	</header>
	    	<aside class="main-sidebar hidden-print ">
	    		<?php include (system::path_theme($theme)."/incl/sidebar.php"); ?>
	    	</aside>
	    	<div class="content-wrapper">
				<?php include (system::path_route($theme,"method","backend")); ?>
			</div>
		</div>
		<?php include (system::path_theme($theme)."/incl/script.php"); ?>
		<script type="text/javascript">
			...
			$(".color-1").on('click',function() {
			    var jqxhr = $.ajax("<?=system::url($theme,"color_css/0/color-1")?>")
				.done(function() {
			...
			$(".color-2").on('click',function(e) {
			    var jqxhr = $.ajax("<?=system::url($theme,"color_css/0/color-2")?>")
				.done(function() {
			...
			$(".color-3").on('click',function() {
			    var jqxhr = $.ajax("<?=system::url($theme,"color_css/0/color-3")?>")
				.done(function() {
			...
			$(".color-4").on('click',function() {
				var jqxhr = $.ajax("<?=system::url($theme,"color_css/0/color-4")?>")
				.done(function() {
			...
			$(".color-5").on('click',function() {
			    var jqxhr = $.ajax("<?=system::url($theme,"color_css/0/color-5")?>")
				.done(function() {
			...
			$(".color-inverse").on('click',function() {
				var jqxhr = $.ajax("<?=system::url($theme,"color_css/0/inverse")?>")
				.done(function() {
