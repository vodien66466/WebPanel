...
<!-- simple line icon -->
<link rel="stylesheet" type="text/css" href="<?=$s->asset(null,"public/assets/icon/simple-line-icons/css/simple-line-icons.css")?>">
<!-- Required Fremwork -->
<link rel="stylesheet" type="text/css" href="<?=$s->asset(null,"public/assets/css/bootstrap.min.css")?>">
<!-- Chartlist chart css -->
<link rel="stylesheet" href="<?=$s->asset(null,"public/assets/plugins/charts/chartlist/css/chartlist.css")?>" type="text/css" media="all">
<!-- Weather css -->
<link href="<?=$s->asset(null,"public/assets/css/svg-weather.css")?>" rel="stylesheet">
<!-- Echart js -->
<script src="<?=$s->asset(null,"public/assets/plugins/charts/echarts/js/echarts-all.js")?>"></script>
<!-- Style.css -->
